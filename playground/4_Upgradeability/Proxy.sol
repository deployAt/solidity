...
//Storage is deployed with ProxyDog (added code to this file as import)
//No need to deploy Storage.sol alone
//instanceOf Storage(ProxyDog) != instanceOf Storage(Dog)
//real data here in Storage(ProxyDog)
